...
INSERT INTO `account` VALUES (1,'a','a','a','a','a','a','Branch Manager','active',1,'north','0',0,0),(2,'b','b','b','b','055','a@b','Client','active',1,'north','1',0,1),(2,'c','b','b','b','055','a@b','Client','active',1,'north','0',0,0),(2,'d','d','b','b','055','a@b','Supplier','active',2,'south','0',0,0),(2,'e','e','b','b','055','a@b','Moderator','active',2,'south','0',0,0),(2,'i','i','b','b','055','a@b','HR','active',1,'north','0',0,0),(2,'mosh','mosh','a','a','a','a','Branch Manager','active',2,'south','0',0,0);
...
INSERT INTO `branch_manager` VALUES (0,'default'),(1,'north'),(2,'south');
...
INSERT INTO `order` VALUES (1,10,'piz','b','2021-12-31 11:30','055','delivery',0,52.9,0,'2021-12-31 15:30',NULL,0,NULL),(2,10,'piz','b','2021-12-31 11:30','055','delivery',0,52.9,0,'2021-12-31 15:30',NULL,0,NULL),(3,10,'piz','b','2021-12-31 11:30','055','delivery',0,52.9,0,'2021-12-31 15:30',NULL,0,NULL),(4,10,'piz','b','2021-12-31 11:30','055','delivery',0,52.9,0,'2021-12-31 15:30',NULL,0,NULL),(5,10,'piz','b','2021-12-31 11:30','055','delivery',0,52.9,0,'2021-12-31 15:30',NULL,0,NULL),(6,10,'piz','b','2021-12-31 11:30','055','delivery',0,52.9,0,'2021-12-31 15:30',NULL,0,NULL),(7,10,'piz','b','2021-12-31 11:30','055','delivery',0,52.9,0,'2021-12-31 15:30',NULL,0,NULL),(8,10,'piz','b','2021-12-31 11:30','055','delivery',0,52.9,0,'2021-12-31 15:30',NULL,0,NULL),(9,10,'piz','b','2021-12-31 11:30','055','delivery',0,52.9,0,'2021-12-31 15:30',NULL,0,NULL),(10,10,'piz','b','2021-12-31 11:30','055','delivery',0,52.9,0,'2021-12-31 15:30',NULL,0,NULL),(11,10,'piz','b','2021-12-31 11:30','055','delivery',0,52.9,0,'2021-12-31 15:30',NULL,0,NULL),(12,10,'piz','b','2021-12-31 11:30','055','delivery',0,52.9,0,'2021-12-31 15:30',NULL,0,NULL),(13,10,'piz','b','2021-12-31 11:30','055','delivery',0,52.9,0,'2021-12-31 15:30',NULL,0,NULL),(14,10,'piz','b','2021-12-31 11:30','055','delivery',0,52.9,0,'2021-12-31 15:30',NULL,0,NULL),(15,10,'piz','b','2021-12-31 11:30','055','delivery',0,52.9,0,'2021-12-31 15:30',NULL,0,NULL),(16,10,'piz','b','2021-12-31 11:30','055','delivery',0,52.9,0,'2021-12-31 15:30',NULL,0,NULL);
...
INSERT INTO `private_account` VALUES ('b','1234567891234567','123','12-2026','2463daba4a677101b6c6968134744ce7dffb1d76d58fc8265b'),('c','1234567891234567','123','12-2026','2e1bf1fcf151182dab0b91e820f5fa693e55488d886670c44b');
...
CREATE TABLE `restaurant` (
  ...
  `ModeratorUserName` varchar(45) DEFAULT NULL,
  ...
  KEY `moderatorUserName_idx` (`ModeratorUserName`),
  ...
  CONSTRAINT `moderatorUserName` FOREIGN KEY (`ModeratorUserName`) REFERENCES `account` (`UserName`)
...
INSERT INTO `restaurant` VALUES (1,'a',1,1,'north','v','c','suchi','asdasd','asdasd',NULL),(2,'steak',1,1,'north',NULL,'d','shushi','raines','this is carnivors restu',NULL),(8,'moshi',1,2,'south',NULL,'d','shushi','raines','Only fish',NULL),(9,'asd',1,2,'south',NULL,'d','shushi','raines','Only vegen',NULL),(10,'piz',1,2,'south',NULL,'d','pizza','raines','Only potatoes',NULL),(17,'pizz',0,2,'south',NULL,'d','pizza','raines','Only potatoes',NULL),(18,'pizz',0,2,'south',NULL,'e','pizza','raines','Only potatoes',NULL);
...
-- Dump completed on 2022-01-03 18:49:32
