...
//
	...
	public void testRegisterSupplierModerator() {
		...
		Restaurant restaurant = new Restaurant(0, false, 2, "pizza", "south", "pizza", "d", null, "raines", "Only potatoes");
		j.getAsJsonObject().add("restaurant", EchoServer.gson.toJsonTree(restaurant));
		sup.getAsJsonObject().addProperty("userName", "u");
		sup.getAsJsonObject().addProperty("userID", 2);
		mod.getAsJsonObject().addProperty("userName", "i");
		mod.getAsJsonObject().addProperty("userID", 2);
		mod.getAsJsonObject().addProperty("supplierUserName", "u");
