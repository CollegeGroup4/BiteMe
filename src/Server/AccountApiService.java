		...
		try {
			...
			while (rs.next()) {
				account = new Account(rs.getInt(finals.ACCOUNT_USER_ID), rs.getString(finals.ACCOUNT_USER_NAME),
						...
						rs.getString(finals.ACCOUNT_AREA), rs.getInt(finals.ACCOUNT_DEBT),
						rs.getString(finals.ACCOUNT_W4C));
...
//				if (rs1.next()) {
//					PrivateAccount privateAccount = new PrivateAccount(rs.getInt(finals.ACCOUNT_USER_ID),
//							rs.getString(finals.ACCOUNT_USER_NAME), rs.getString(finals.ACCOUNT_PASSWORD),
...
//							rs.getInt(finals.ACCOUNT_DEBT), rs.getString(finals.ACCOUNT_W4C), rs1.getString(2),
...
//				if (rs1.next()) {
//					BusinessAccount businessAccount = new BusinessAccount(rs.getInt(finals.ACCOUNT_USER_ID),
//							rs.getString(finals.ACCOUNT_USER_NAME), rs.getString(finals.ACCOUNT_PASSWORD),
//							rs.getString(finals.ACCOUNT_FIRST_NAME), rs.getString(finals.ACCOUNT_LAST_NAME),
//							rs.getString(finals.ACCOUNT_EMAIL), rs.getString(finals.ACCOUNT_TYPE),
//							rs.getString(finals.ACCOUNT_PHONE), rs.getString(finals.ACCOUNT_STATUS),
//							rs.getInt(finals.ACCOUNT_BRANCH_MANAGER_ID), rs.getString(finals.ACCOUNT_AREA),
//							rs.getInt(finals.ACCOUNT_DEBT), rs.getString(finals.ACCOUNT_W4C), rs1.getFloat(2),
